...
int pasivo(int s) {
    ...
    int nport;                      /* puerto en el servidor */
    char cmd[128], res[128], *p;    /* comando y respuesta FTP */
    char host[64], port[8];         /* host y puerto del SVR */
    int h1, h2, h3, h4, p1, p2;     /* octetos */
...
int main(int argc, char *argv[]) {
    ...
    char *service = "ftp";     /* servicio por defecto */
    char cmd[128], res[128];
    char data[LINELEN + 1];
    char hdata[64], pdata[8], user[32], *pass;
        ...
        if (fgets(prompt, sizeof(prompt), stdin) != NULL) {
            ...
            /* ---------------------- GET ---------------------- */
                ...
                if (pid < 0) {
                    ...
                    /* PADRE */
                    printf("Descargando '%s' en segundo plano (PID=%d)\n", arg, pid);
                }
            }
            ...
            /* ---------------------- PUT ---------------------- */
                ...
                if (pid < 0) {
                    ...
                    /* PADRE */
                    printf("Subiendo '%s' en segundo plano (PID=%d)\n", arg, pid);
                }
            }
